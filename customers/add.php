...
<form action="add.php" method="post">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-2">
            ...
            <input type="text" class="form-control" name="customer['birthdate']"> </div>
    </div>
    <div class="row">
        ...
        <div class="form-group col-md-2">
            ...
            <input type="text" class="form-control" name="customer['created']" disabled> </div>
    </div>
    <div class="row">
        <div class="form-group col-md-3">
        ...
        <div class="form-group col-md-2">
            ...
            <input type="text" class="form-control" name="customer['ie']"> </div>
        <div class="form-group col-md-2">
            <label for="campo3">UF</label>
