...
<?php endif; ?>
<dl class="dl-horizontal"> <dt>Nome / Razão Social:</dt>
    <dd>
...
<dl class="dl-horizontal"> <dt>Endereço:</dt>
    <dd>
        <?php echo $customer[ 'address']; ?>
    </dd>
    <dt>Bairro:</dt>
    <dd>
        <?php echo $customer[ 'hood']; ?>
    </dd>
    <dt>CEP:</dt>
    <dd>
        <?php echo $customer[ 'zip_code']; ?>
    </dd>
...
<dl class="dl-horizontal"> <dt>Cidade:</dt>
    <dd>
